...
\algoritmo{hippieAEst?}{in as:as, in pos:pos}{res:bool}{
 ...
 \algoritmo{aplicarHippiesVecinos}{in/out as:as, in pos:pos}{}{
    ...
    \While {$i < vecinos.tamanio()$} \complejidad{O(long(nombre))}
       \If {$as.campus[vecinos[i].x][vecinos[i].y].hayHippie$}
          \If {$as.hippieAEst(vecinos.siguiente)$} \complejidad{O(1)}
              \State $as.campus[vecinos[i].x][vecinos[i].y].hayHippie \larr False$ \complejidad{O(1)}
              \State $as.campus[vecinos[i].x][vecinos[i].y].hayEst \larr True$ \complejidad{O(1)}
              \State $as.campus[vecinos[i].x][vecinos[i].y].hippie \larr CrearIt(as.hippies)$ \complejidad{O(1)}
              \State $as.campus[vecinos[i].x][vecinos[i].y].hippie.agregarComoSiguiente(as.campus[vecinos[i].x][vecinos[i].y].estudiante.nombre)$ \complejidad{O(long(nombre))}
              \State $as.campus[vecinos[i].x][vecinos[i].y].estudiante.eliminarSiguiente()$ \complejidad{O(long(nombre))}
          \Else
            \If {$as.campus[vecinos[i].x][vecinos[i].y].hayHippie?$ $\land$ $atrapadoPorAgente(vecinos[i])$}
                ...
                \State $as.campus[vecinos[i].x][vecinos[i].y].hippie.eliminarSiguiente()$ \complejidad{O(long(nombre))}
            \EndIf
          \EndIf
        \EndIf
    \EndWhile
 ...
 \algoritmo{capturarHippie}{in/out as:as, in pos:pos}{}{
    \State // PRE: pos valida y hayHippie en as.campus[pos.x][pos.y]
    \If {$atrapadoPorAgente?(as, pos, as.campusEstatico.vecinos(pos))$}
        \State $as.campus[pos.x][pos.y].hippie.eliminarSiguiente()$ \complejidad{O(1)}
